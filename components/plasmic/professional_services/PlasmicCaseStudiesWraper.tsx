...
import sty from "./PlasmicCaseStudiesWraper.module.css"; // plasmic-import: sQiQl3EHt-JM/css
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img__ix0JP)}
            displayHeight={"auto"}
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <Button
                className={classNames("__wab_instance", sty.button__uGEnd)}
                color={"blackCoffee"}
                submitsForm={true}
              >
                <div
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicCaseStudiesWraper__VariantsArgs, ReservedPropsType> &
