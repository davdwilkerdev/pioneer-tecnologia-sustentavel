...
import MenuPopover from "../../MenuPopover"; // plasmic-import: 8ZclVUzXEjPd/component
import MenuItem from "../../MenuItem"; // plasmic-import: I-NKvNBLEqyH/component
import MenuSection from "../../MenuSection"; // plasmic-import: vX0G35878AfY/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: 85xamSaj0I8e/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__pu8Ld)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
