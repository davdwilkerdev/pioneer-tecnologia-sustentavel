...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: n_f_HhWul6aT/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox__sSqYx)}>
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__qg)}>
        <div
