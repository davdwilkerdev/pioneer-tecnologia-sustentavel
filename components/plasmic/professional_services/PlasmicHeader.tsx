...
import sty from "./PlasmicHeader.module.css"; // plasmic-import: lKu0B9xgLMgZ/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__gxCWw)}>
            <PlasmicLink__
          ...
          <div className={classNames(projectcss.all, sty.column__q6TY)}>
            <div
