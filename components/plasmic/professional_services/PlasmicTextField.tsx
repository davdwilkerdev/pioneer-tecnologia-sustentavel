...
import Label from "../../Label"; // plasmic-import: bWkpUnuPFuIl/component
import TextInput from "../../TextInput"; // plasmic-import: P9KrKOMMZQe6/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: gbDWkdZPwxPu/component
import Description from "../../Description"; // plasmic-import: gICzEbUWUE40/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: ZmLTKTe6R0z1/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__mkIsB, {
          [sty.freeBoxiconEnd__mkIsBZ0K1]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__mkIsB4Ssrw]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__mkIsBjfj0R]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__ofeqe, {
            [sty.freeBoxiconStart__ofeqe4Ssrw]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__ofeqeJfj0R]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___3HJTk)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__jU5G, {
            [sty.freeBoxiconEnd__jU5GZ0K1]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__jU5G4Ssrw]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___8RldB)}
                role={"img"}
              />
            ),
