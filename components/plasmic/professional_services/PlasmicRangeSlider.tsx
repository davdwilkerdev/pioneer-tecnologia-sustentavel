...
import SliderThumb from "../../SliderThumb"; // plasmic-import: MJNHpO1NRZzA/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: CaJD2Xom3-rW/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__zxQlG)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__yl6Rg)}>
        <div
