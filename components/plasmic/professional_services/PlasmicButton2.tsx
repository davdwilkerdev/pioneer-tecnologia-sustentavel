...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: qpofC4880vte/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: yO_4FdlnAaiU/icon
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: Ql2ZXxbweitH/icon
...
function PlasmicButton2__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__m0Jxs, {
          [sty.freeBoxcolor_neutral__m0JxsHz8WU]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__m0JxsTw36BDg6W0]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__m0Jxs1XCna]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__m0JxsQbNf8]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__m0JxsJkQ4O]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__m0JxsnXDrS]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__m0JxsODjcr]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__m0Jxsdg6W0]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___76GfV, {
            [sty.freeBoxcolor_neutral___76GfVhz8WU]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft___76GfVhz8WUY75Bn]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart___76GfV8KtWv]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge___76GfVQbNf8]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___76GfVnXDrS]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___76GfVoDjcr]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered___76GfVdg6W0]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__yW1Ti)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__sWiDy, {
            [sty.freeBoxiconEnd__sWiDyZxS1Q]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__sWiDyQbNf8]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__sWiDynXDrS]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__sWiDyODjcr]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__vs1N6)}
                role={"img"}
              />
            ),
