...
import sty from "./PlasmicAboutUs.module.css"; // plasmic-import: wb0XQ_F8WDln/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox___9EEdl)}>
              <h1
          ...
          <section className={classNames(projectcss.all, sty.section__wrbUi)}>
            <div className={classNames(projectcss.all, sty.freeBox__bRoL9)}>
              <div className={classNames(projectcss.all, sty.columns__bGrvc)}>
                <div className={classNames(projectcss.all, sty.column__fUuYs)}>
                  <div
                    className={classNames(projectcss.all, sty.freeBox__dfw8N)}
                  >
                    <h2
                      className={classNames(
                        projectcss.all,
                ...
                <div className={classNames(projectcss.all, sty.column__vzvuR)}>
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__e7OEz)}
                    displayHeight={"100%"}
          ...
          <section className={classNames(projectcss.all, sty.section__oA5Tt)}>
            <div className={classNames(projectcss.all, sty.freeBox__mujZg)}>
              <div className={classNames(projectcss.all, sty.freeBox__nluf5)}>
                <div className={classNames(projectcss.all, sty.freeBox__gpaQy)}>
                  <h2
                    className={classNames(
                      projectcss.all,
                      projectcss.h2,
                  ...
                  <div
                    className={classNames(projectcss.all, sty.columns__w5Bvs)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.column__bQjkx)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                    ...
                    <div
                      className={classNames(projectcss.all, sty.column__qtQzg)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
          ...
          >
            ...
            >
              ...
              <div className={classNames(projectcss.all, sty.freeBox___5Q0UY)}>
                <div className={classNames(projectcss.all, sty.freeBox__h8Q6)}>
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__lyJ6L)}
                    displayHeight={"48px"}
                    displayMaxHeight={"none"}
                  ...
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img___3FyPr)}
                    displayHeight={"48px"}
                    displayMaxHeight={"none"}
                    displayMaxWidth={"none"}
                    displayMinHeight={"0"}
                  ...
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__xuu3R)}
                    displayHeight={"48px"}
                    displayMaxHeight={"none"}
                    displayMaxWidth={"none"}
                    displayMinHeight={"0"}
                  ...
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__cuDgC)}
                    displayHeight={"48px"}
                    displayMaxHeight={"none"}
                    displayMaxWidth={"none"}
                    displayMinHeight={"0"}
