...
import Radio from "../../Radio"; // plasmic-import: ADTNRXQxcZgt/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: gPOXOFI6Me35/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__zOppm)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__fhMla)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__nmfj2)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__qPEwW)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
