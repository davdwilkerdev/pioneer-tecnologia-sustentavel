...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: XweTtAv8nTj_/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: reC4YphT7D0W/css
  ...
  return (
    <BaseDialogTrigger
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div
                  className={classNames(projectcss.all, sty.freeBox___3LDmG)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button2
            className={classNames("__wab_instance", sty.button2___1Sm4D)}
            label={"Open Popover"}
          />
        ),
