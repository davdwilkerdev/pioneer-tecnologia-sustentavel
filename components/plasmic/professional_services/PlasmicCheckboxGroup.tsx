...
import Checkbox from "../../Checkbox"; // plasmic-import: zF565QIlOC0e/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: 8X_Gk_h1TdWG/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__bFlvk)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__d4BVr)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__xfn7R)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___9PlIw)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
