...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: I-NKvNBLEqyH/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___1LIcF)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__wu9HM)}>
            <div
              className={classNames(
                projectcss.all,
