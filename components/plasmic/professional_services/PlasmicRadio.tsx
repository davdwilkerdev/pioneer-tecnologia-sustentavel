...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: ADTNRXQxcZgt/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__hZh5X)}>
        <div className={classNames(projectcss.all, sty.freeBox___3Rmjs)} />
      </div>
      {renderPlasmicSlot({
