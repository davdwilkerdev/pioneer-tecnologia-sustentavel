...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: zF565QIlOC0e/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: rWD_XdzoswVn/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: dmAB1KEYj0SW/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__fGrBk)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__nwP63)}
            role={"img"}
          />
        ) : null}
      </div>
