...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 0tgqUcDpHMTR/css
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__nRBfG)}>
        {renderPlasmicSlot({
          defaultContents:
      ...
      <div className={classNames(projectcss.all, sty.freeBox__lz5Hc)}>
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__sBm4O)}
                displayHeight={"64px"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox__vLyn)}>
                <div className={classNames(projectcss.all, sty.freeBox__ecMvo)}>
                  <h5
                    className={classNames(
                      projectcss.all,
                      projectcss.h5,
