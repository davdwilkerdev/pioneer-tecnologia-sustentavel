...
import sty from "./PlasmicServicesWhite.module.css"; // plasmic-import: JZUuLltS-WiV/css
...
function PlasmicServicesWhite__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___8QsB)}>
        {renderPlasmicSlot({
          defaultContents: (
            <Icon8Icon
              className={classNames(projectcss.all, sty.svg__skQ6)}
              role={"img"}
            />
          ),
      ...
      <div className={classNames(projectcss.all, sty.freeBox__wb3Wl)}>
        <h3
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicServicesWhite__VariantsArgs, ReservedPropsType> &
